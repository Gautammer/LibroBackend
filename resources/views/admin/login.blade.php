...
<html lang="en">
	...
	<head>
		<base href="../../../">
		<meta charset="utf-8" />
		<title>Login | Libro Service Admin </title>
		...
		<link href="{{ asset('assets/plugins/general/perfect-scrollbar/css/perfect-scrollbar.css') }}" rel="stylesheet" type="text/css" /> <link href="{{ asset('assets/plugins/general/tether/dist/css/tether.css') }}" rel="stylesheet" type="text/css" />
					...
					<div class="kt-grid__item kt-grid__item--order-tablet-and-mobile-2 kt-grid kt-grid--hor kt-login__aside" style="background-image: url(assets/media//bg/bg-4.jpg);">
						...
						<div class="kt-grid__item kt-grid__item--fluid kt-grid kt-grid--ver">
							<div class="kt-grid__item kt-grid__item--middle">
								<h3 class="kt-login__title">Welcome to Libro Servic Admin!</h3>
								<h4 class="kt-login__subtitle">The Libro Service is a freeware app for instant Service  on electronic devices or home service. The service is operated by Libro Service Inc.</h4>
							</div>
						</div>
						<div class="kt-grid__item">
							<div class="kt-login__info">
								<div class="kt-login__copyright">
									&copy 2019 Libro Service Inc.
								</div>
					...
					<div class="kt-grid__item kt-grid__item--fluid  kt-grid__item--order-tablet-and-mobile-1  kt-login__wrapper">
						...
						<div class="kt-login__body">
							...
							<div class="kt-login__form">
								...
								<!--begin::Form-->
								<form class="admin_login_form" data-url="{{ route('admin.login') }}" id="admin_login_form">
									<div class="form-group">
										@csrf
										<input class="form-control" type="email" placeholder="Email" name="uemail" autocomplete="off">
									</div>
									<div class="form-group">
									...
									<div class="form-group">
										<label class="kt-checkbox kt-checkbox--tick kt-checkbox--brand mt-3 mb-0">
									...
									<div class="kt-login__actions mt-3">
										...
										<button id="admin_login_submit" class="btn btn-block btn-primary btn-elevate kt-login__btn-primary">Sign In</button>
